                ...
                <div  className='nav-element' onClick={this.showSubNav}>
                  ...
                  {this.state.subNav && 
                    <div className='product-element'>
                      <a href='https://pylon.finance/' target='_blank' className='drop-element'><span className='nav-text'>Pylon Finance</span><RiIcons.RiExternalLinkLine className='icons'/></a>
                      <a href='https://www.darkpylon.com/' target='_blank' className='drop-element'><span className='nav-text'>Dark Pylon</span><RiIcons.RiExternalLinkLine className='icons'/></a>
                    </div>
                  }
                </div>
